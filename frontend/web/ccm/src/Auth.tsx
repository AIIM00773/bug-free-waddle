      ...
      <div className="flex-1 flex flex-col justify-center items-center px-4 sm:px-8 bg-slate-50 relative">
        ...
        <div className="w-full max-w-[380px] space-y-5 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/60 shadow-xl shadow-slate-200/40">
          ...
          <div className="relative flex py-1 items-center">
            ...
            <span className="shrink-0 mx-3 text-[9px] text-slate-400 font-bold uppercase tracking-wider">or continue with</span>
            <div className="flex-1 border-t border-slate-200/80"></div>
          </div>

          {/* Google SSO Button */}
          <button className="w-full bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 text-xs font-bold py-2.5 rounded-xl transition flex items-center justify-center gap-2 shadow-sm shadow-slate-100">
