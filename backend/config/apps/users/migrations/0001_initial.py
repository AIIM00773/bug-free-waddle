# Generated by Django 5.2.16 on 2026-08-17 05:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "country",
                    models.CharField(db_index=True, default="Kenya", max_length=100),
                ),
                ("country_code", models.CharField(default="254", max_length=10)),
                ...
                ("estate_area_neighborhood", models.TextField(blank=True, null=True)),
                ("apartment_door_id", models.TextField(blank=True, null=True)),
                ("location_explanation", models.TextField(blank=True, null=True)),
                ...
                ("allow_phone_notification", models.BooleanField(default=True)),
                ("allow_email_notification", models.BooleanField(default=True)),
                ("allow_whatsApp_dispatch_alerts", models.BooleanField(default=True)),
                ("allow_phone_pings", models.BooleanField(default=True)),
                (
                    "last_ip_address",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("merchant", models.JSONField(blank=True, max_length=100, null=True)),
                ("product", models.JSONField(blank=True, max_length=100, null=True)),
                (
                    "price",
                    models.DecimalField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("action_link", models.URLField(blank=True, max_length=500)),
